...
The goal is to order the users such as for sorting. Return -1 if A comes before B, 1 
...
object _18userCompare{
    ...
    def main(args: Array[String]) {
        println("userCompare(\"bb\", 1, \"zz\", 2) =>" + userCompare("bb", 1, "zz", 2) );
        println("userCompare(\"bb\", 1, \"aa\", 2) =>" + userCompare("bb", 1, "aa", 2) );
        println("userCompare(\"bb\", 1, \"bb\", 1) =>" + userCompare("bb", 1, "bb", 1) );
    }
}
/*
userCompare("bb", 1, "zz", 2) =>-1
