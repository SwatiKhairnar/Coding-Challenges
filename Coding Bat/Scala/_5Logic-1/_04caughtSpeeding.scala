...
object _04caughtSpeeding{
    def caughtSpeeding(speed:Int,isBirthday:Boolean):Int = {
        ...
        if(isBirthday)
		  ...
		  */
		var extracases = 0
		if(isBirthday) extracases = 5
		if(speed <= (60 + extracases) )return 0
		else if(speed > (60 + extracases) && speed <= (80 + extracases)) return 1
		else return 2
    }
  

  def main(args: Array[String]) {
    println("caughtSpeeding(60, false) -> " + caughtSpeeding(60, false))
    println("caughtSpeeding(65, false) -> " + caughtSpeeding(65, false))
    println("caughtSpeeding(65, true) -> " + caughtSpeeding(65, true))
  }
}
