...
object _06alarmClock {
    ...
    println("alarmClock(1, false) = " + alarmClock(1, false))
    println("alarmClock(5, false) = " + alarmClock(5, false))
    println("alarmClock(0, false) = " + alarmClock(0, false))
    }
}
