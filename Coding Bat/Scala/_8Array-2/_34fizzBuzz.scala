...
beginning at start and running up to but not including end, so for example start=1 and end=5 gives the series 1, 2, 3, 4. 
...
object _34fizzBuzz{
    ...
    def main(args: Array[String]) {
        println("fizzBuzz(1, 6) = " + fizzBuzz(1, 6).mkString(",") );
        println("fizzBuzz(1, 8) = " + fizzBuzz(1, 8).mkString(",") );
        println("fizzBuzz(1, 11) = " + fizzBuzz(1, 11).mkString(",") );
    }
}
/*
